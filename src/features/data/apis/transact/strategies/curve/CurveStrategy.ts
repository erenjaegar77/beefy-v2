...
class CurveStrategyImpl implements IComposableStrategy<StrategyId> {
...
export const CurveStrategy = CurveStrategyImpl satisfies IComposableStrategyStatic<StrategyId>;
