 ...
 */
class BalancerStrategyImpl implements IComposableStrategy<StrategyId> {
...
export const BalancerStrategy =
  BalancerStrategyImpl satisfies IComposableStrategyStatic<StrategyId>;
